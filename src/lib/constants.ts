...
export const stats = [
  ...
  { id: 3, value: "50+", label: "Industry Partners" },
...
export const footerLinks = {
  ...
  services: [
    ...
    { href: "#", label: "Custom Alloy Development" },
    { href: "#", label: "Advanced Manufacturing" },
    { href: "#", label: "Heat Treatment" },
    { href: "#", label: "Quality Testing" },
    { href: "#", label: "Design Consultation" }
  ],
  legal: [
...
export const galleryImages = [
  {
    id: 1,
    title: "Metal Welding Process",
    category: "process",
    image: "https://images.unsplash.com/photo-1605201100110-1f07883d2882?auto=format&fit=crop&w=800&q=80"
  },
  {
    id: 2,
