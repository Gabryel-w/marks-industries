        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-gray-800">Indústria<span className="text-primary font-light">Marks</span></span>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="mailto:info@thompsonmetalcraft.com" className="bg-gray-100 hover:bg-primary/10 text-primary p-2 rounded-full transition-colors">
          ...
          <div>
            <h3 className="font-medium text-gray-800 text-lg mb-5">Quick Links</h3>
          ...
          <div>
            <h3 className="font-medium text-gray-800 text-lg mb-5">Our Services</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="font-medium text-gray-800 text-lg mb-5">Contact Us</h3>
